...
__[ Step 3 ]__  
Once all of the players have their palms against one another, the players will clap simultaneously (two claps in quick succession is usually enough) and will repeat step 2.  
...
__[ Step 4 ]__  
After step 2 has been repeated, the players are now free to make the defensive and offensive moves of their choice --- given that it is legal and that they have the sufficient charges to perform their desired offensive move.  
...
- Two-charge Moves
  ...
  -   Hit: N/A (spoken verbally)
  -   Dx-Bang-Bang*: Same as Mini-Ho
 
- Three-charge Moves
  - A-Bomb: N/A (spoken verbally)
 
- Four-charge Moves
  - Nuke: N/A (spoken verbally)
  - Hit-Homing N/A (spoken verbally)
 
- Legal Custom Moves
  - The player performs the listed actions respective to the moves they plan to do or say

- Illegal / Banned Moves*
  - Troll Bang*: The player performs the "Bang" move before the game has officially started (which is at Round 0)
  - RPG: The player lifts their elbow up and directs it towards one of their opponents
  - Black Hole: N/A (spoken verbally)
  - Illegal Custom Moves: The player performs the listed actions respective to the moves they plan to do or say
...
- Any Offensive Move
  - T1: The player is removed from the circle when attacked by any offensive move with a charge requirement larger than the player's offensive move

Notes:  
For more information on what moves a player can perform see "README.md".  
*1 The original name and hand gesture for "forfeit" is not appropriate so the author chose to name the move "forfeit" instead.  
()2 Targeting: The player must point at their target, or the player of their choice through the direction of their fingers to direct the attack, those who fail to aim properly are treated as cheaters and may be kicked from the session.  
*3 "D", when used alone, is considered useless, and it is not recommended to play this at all as other moves do this in a more efficient and effective manner. Nevertheless, it is in the game as it is the "base form" of "DX" and its variants.  
*4 One "Bang" is practically equivalent to a "Bang-Bang" gameplay-wise so any Bang variant with more than one Bang is considered useless and it is not recommended to play such moves at all as a single Bang or a split Bang does such moves in a more efficient and effective manner.  
*5 For unknown reasons, "DX-Bang-Bang" is pronounced as "Babaduxs". No one uses "Bang-Bang-DX" though so there is typically no sort of confusion that arises from here.  
*6 These moves have been banned universally by the author's school community through shared opinion and these moves have quietly been forgotten way before Charge itself was forgotten.  
*7 No one knows exactly who, how, and why this was even conceived in the first place besides for trolling.  
*8 Players will usually pound their chest once to show that the final offensive move (broke their defense and) have eliminated them.  
*9 This is to represent the "bullet" or Bang going in between the Barrier hand signal. Additionally, it has been forgotten if D could bypass Barrier in the same way Bang does. Moreover, despite DX being part D, it does not eliminate a player using Barrier.   

-------------------------------------------------------  

__[ Step 5a ]__  
Initiate step 2 at the start of each round and proceed with step 4 until all players are eliminated.

-------------------------------------------------------  

__[ Step 5b ]__  
When a player's defense fails, or when a player is eliminated in general, they are removed from the circle and the game carries on as usual. The game will continue until there is one player left remaining.  
It is impossible to reach a tie when there are two players left in a round. However, it is possible to achieve a draw during certain situations in a round containing three or more players.  
